...
from ..users.models import User , UserComments ,User_Favorite , User_Favorite_Category ,Support_Message
from ..meals.models import Meal_ingredient , Meal  , Category , Area , Ingredient
from flask_login import current_user
from flask_admin import expose,AdminIndexView
import os
from flask import render_template ,Blueprint , abort ,redirect ,flash ,current_app ,request
...
adm = Blueprint('adm', __name__, template_folder='templates' ,url_prefix='/admin')
...
class AdminIndexPage(AdminIndexView) :
    ...
    def index(self):
        ...
        return self.render('admin/index_page.html', 
